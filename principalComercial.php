...
$(document).ready(function(){
    ...
    <body style="background-color: #6F2424">
        ...
        <div class="text-center">
            <h3 style="color:white">Desde aquí puedes administrar las lineas de los clientes</h3>
            <br>
            <div style="padding-bottom: 2%;">
                <button class="btn btn-danger" onclick="location.href='gestorTarifasComercial.php'">Modificar lineas de usuarios</button>
                                    ...
                                    <tr>
                                        ...
                                        <!-- -->
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-4">
                                                  <button data-state="0" data-dnipass="<?= $dni?>" name="ver" class="ver btn btn-danger">Ver líneas</button>
                                                  </div>
                                                </div>
